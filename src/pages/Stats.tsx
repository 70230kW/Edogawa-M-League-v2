...
import { TrendingUp, Target, Calendar, TableProperties, Swords, ChevronDown } from 'lucide-react';
                      ...
                      <tr key={row.player.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                        <td className="py-2 pl-3 sticky left-0 bg-bg-card">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-white/80 text-[11px] truncate" style={{ maxWidth: 56 }}>{row.player.name}</span>
                          </div>
                        </td>
